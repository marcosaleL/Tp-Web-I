...
function iniciarpageStats(){
    ...
    function mostrarTabla(){
        ...
        for (let index = 0; index < rowsGoles.length; index++) {
            ...
            '<td><button class = "btnEdit btnTable" id = "' + rowsGoles[index]._id + '"> Edit </button> </td></tr>'
        }
        ...
        botones = document.querySelectorAll(".btnEdit");
        ...
        for (let index = 0; index < botones.length; index++) {
            ...
            botones[index].addEventListener("click", function(){
                ...
                for (d of datos){
                    //En vez de hacerle toggle, tengo que hacerle add
                    // con el botone "save" le tengo que hacer delete
                    d.toggleAttribute("readonly");
                    d.classList.toggle("editing");
                }
                
                //editRow(index,botones[index].id);
            })
        }   
